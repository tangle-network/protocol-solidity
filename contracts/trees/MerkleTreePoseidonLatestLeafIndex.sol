...
import "./MerkleTreeWithHistoryPoseidonLatestLeafIndex.sol";

contract MerkleTreePoseidonLatestLeafIndex is MerkleTreeWithHistoryPoseidonLatestLeafIndex {
    constructor(uint32 _levels, IPoseidonT3 _hasher) MerkleTreeWithHistoryPoseidonLatestLeafIndex(_levels, _hasher) {
