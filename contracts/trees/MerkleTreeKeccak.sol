...
contract MerkleTreeKeccak is MerkleTreeWithHistoryKeccak {
  ...
  /// @dev provides Zero (Empty) elements for a Poseidon MerkleTree. Up to 32 levels
    function zeros(uint256 i) override public pure returns (bytes32) {
        ...
        else if (i == 21) return bytes32(0x5fc8c1e9d260531cade53159072fe9f14921a9559e5222dca7e28d504ab3dd04);
        else if (i == 22) return bytes32(0x7ef08ed4b30c17c851a892c539030a92e5319857aa0cd453330a31a0183ac975);
        else if (i == 23) return bytes32(0x6420ebe493376e2596f8082f7902dd5c83af477fa9e5d52b74f0f7759e2a9068);
        else if (i == 24) return bytes32(0x93766eb9a297fe6ca5c12f268f84999d275250c2408aaea8a0a66aa7aef520a9);
        else if (i == 25) return bytes32(0x52b9d8e178f12c49cd409cffc0a54139816ad9de9261f49d75e0cca3c581fab8);
        else if (i == 26) return bytes32(0x5191df2c0bd0f66075ef15f47daf661fab17bd7d9520e1b011c5f7cb17ac1c3c);
        else if (i == 27) return bytes32(0xca95564bdcd199f493f50a366e5a1ba1d749f136e586c2e81127fa0bba6b3076);
        else if (i == 28) return bytes32(0x6955b26d7325787f232d42480b9dce4241793c3fe249ea6fbe03c6a798b20512);
        else if (i == 29) return bytes32(0x02fab0f86aba653fbd368bbee2baa6092199592c90397b8c4b414803910e2553);
        else if (i == 30) return bytes32(0x3878a3ff0eda8bcd772059f6c38939e9b4888d7848b36e8645e3929e0ba2f974); 
        else if (i == 31) return bytes32(0x819bff9ae5cb51403b906d369e5a1bbd8b791c51f7c27d3be41f9271d9434af1);
