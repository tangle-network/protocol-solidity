...
contract PlonkVerifier8 {
    ...
    uint16 constant n =   65536;
    uint16 constant nPublic =  15;
    uint16 constant nLagrange = 15;
    
    uint256 constant Qmx = 6861591472926925257756897080798141377339387677286201159250433880387273043743;
    uint256 constant Qmy = 3254794244501819545383744477357495949344772112230956070985846365900368165382;
    uint256 constant Qlx = 18762792450362764675940717048812900214486263777137774389972256226550897839781;
    uint256 constant Qly = 7708332039038919922082457461723644650767804831163617361458075554791145575722;
    uint256 constant Qrx = 7624032645773461436187344258753241028011322853686491934481365334521858602165;
    uint256 constant Qry = 2215762006183490564145497011561153375648786385763567681130313500597027128462;
    uint256 constant Qox = 10240275134255437283965292434610203156751565686255843384893708167443477019998;
    uint256 constant Qoy = 5312276020739441613623686596691993493961612299778153153370224091290794324328;
    uint256 constant Qcx = 8479031862021870234542006930090168948315424708961303794034585685782727413125;
    uint256 constant Qcy = 9896678116631115527135888964782032867159616917737790647094811390811422284818;
    uint256 constant S1x = 19025349222119479548532061168325198426875623268421072304012735998729900202114;
    uint256 constant S1y = 18033168293540366135865301574280401909140718539070308530251057559303719504172;
    uint256 constant S2x = 2758946985158646652892352101414035690325176304202109089220663437654780548902;
    uint256 constant S2y = 2688086330155593566783340642648936459788264048070447535852902229248323497612;
    uint256 constant S3x = 2440345211347444057219213890076240288831620262510114603334406816708766934248;
    uint256 constant S3y = 18537927612800452481288790947684632067235911437620493806151780278020300263344;
    ...
    function verifyProof(bytes memory proof, uint[] memory pubSignals) public view returns (bool) {
        assembly {
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 16 )
