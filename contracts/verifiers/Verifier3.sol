...
contract PlonkVerifier3 {
    ...
    uint16 constant n =   131072;
    uint16 constant nPublic =  10;
    uint16 constant nLagrange = 10;
    
    uint256 constant Qmx = 4454142922226628535200889208344572986852744122640324753629727816519365355534;
    uint256 constant Qmy = 8221884817592974247057203328314160471429140263996523399491878391294296884377;
    uint256 constant Qlx = 14935576330990635109151840470991799172647152687206967654797443720363273225255;
    uint256 constant Qly = 16990259438021514938211988218805183995231005224259674926034848727304074797934;
    uint256 constant Qrx = 9780110832599324688059422009822670482028657039938628678190027132462852461006;
    uint256 constant Qry = 12812099273200850682832669127990525667616987129563391981273278103043415651832;
    uint256 constant Qox = 6335706358438232650738500909792651317303847074297185347885959769739563669000;
    uint256 constant Qoy = 18804628375497538443163740628882628023928073847266473389982091586554185227906;
    uint256 constant Qcx = 8402235645078990643169811393534361766398616881268564028431973242399014819776;
    uint256 constant Qcy = 14568698227839789553530974774587143624889402089633657984317814678539920532329;
    uint256 constant S1x = 5805574991919437707695063751329356916742546444668477599638331708440740303874;
    uint256 constant S1y = 16951173756157991115669406708699358268846218081172189454672848405900852697641;
    uint256 constant S2x = 18403396122315194659469344999976629707206316302232041652297058165978994506458;
    uint256 constant S2y = 20213226907964171104515969537452839121961727738526211066040218104138499976835;
    uint256 constant S3x = 17206166441148954674212544761388596124894490957443662740517198813758423230246;
    uint256 constant S3y = 15019753592051085465144751948436177089913213514560091456395638927172026302083;
    ...
    function verifyProof(bytes memory proof, uint[] memory pubSignals) public view returns (bool) {
        assembly {
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 11 )
