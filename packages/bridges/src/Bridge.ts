...
export class Bridge {
  ...
  public static async deployFixedDepositBridge(bridgeInput: BridgeInput, deployers: DeployerConfig, zkComponents: ZkComponents): Promise<Bridge> {
    ...
    for (let chainID of bridgeInput.chainIDs) {
      ...
      bridgeInstance.setAnchorHandler(handler);
  ...
  public static async setPermissions(bridgeSide: BridgeSide, anchors: IAnchor[]): Promise<void> {  
