...
import { IAnchorV2 } from '../../interfaces/src';
...
export class VAnchorV2 implements IAnchorV2 {
  ...
  public static async createVAnchor(
    ...
    const factory = new VAnchorV2__factory(
    ...
    const createdVAnchor = new VAnchorV2(
      vAnchor,
      signer,
  ...
  public static async connect(
    ...
    const anchor = VAnchorV2__factory.connect(address, signer);
    const maxEdges = await anchor.maxEdges();
    const treeHeight = await anchor.levels();
    const createdAnchor = new VAnchorV2(
      anchor,
      signer,
      treeHeight,
      maxEdges,
