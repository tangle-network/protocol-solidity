...
import {
  ...
  VAnchorForestEncodeInputs__factory,
...
export class VAnchorForest {
  ...
  public static async createVAnchor(
    ...
    const encodeLibraryFactory = new VAnchorForestEncodeInputs__factory(signer);
    ...
    const factory = new VAnchorForest__factory(
      {
        ['contracts/libs/VAnchorForestEncodeInputs.sol:VAnchorForestEncodeInputs']: encodeLibrary.address,
        ['contracts/hashers/Poseidon.sol:PoseidonT3']: poseidonLib.address,
