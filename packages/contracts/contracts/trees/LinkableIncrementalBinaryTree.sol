...
library LinkableIncrementalBinaryTree {
	...
	function init(LinkableIncrementalTreeData storage self, uint256 depth) public {
		require(
	...
	function _insert(LinkableIncrementalTreeData storage self, uint256 leaf) internal {
	...
	function _update(
		...
		require(index < 2 ** self.depth, "Cannot update leaf outside of tree");
		uint256 hash = leaf;
    ...
    */
	...
	function zeros(uint256 i) public pure returns (uint256) {
		...
		else if (i == 2) return 0x217126fa352c326896e8c2803eec8fd63ad50cf65edfef27a41a9e32dc622765;
		else if (i == 3) return 0x0e28a61a9b3e91007d5a9e3ada18e1b24d6d230c618388ee5df34cacd7397eee;
		else if (i == 4) return 0x27953447a6979839536badc5425ed15fadb0e292e9bc36f92f0aa5cfa5013587;
		...
		else if (i == 7) return 0x267855a7dc75db39d81d17f95d0a7aa572bf5ae19f4db0e84221d2b2ef999219;
		else if (i == 8) return 0x1184e11836b4c36ad8238a340ecc0985eeba665327e33e9b0e3641027c27620d;
		else if (i == 9) return 0x0702ab83a135d7f55350ab1bfaa90babd8fc1d2b3e6a7215381a7b2213d6c5ce;
		else if (i == 10) return 0x2eecc0de814cfd8c57ce882babb2e30d1da56621aef7a47f3291cffeaec26ad7;
		else if (i == 11) return 0x280bc02145c155d5833585b6c7b08501055157dd30ce005319621dc462d33b47;
		else if (i == 12) return 0x045132221d1fa0a7f4aed8acd2cbec1e2189b7732ccb2ec272b9c60f0d5afc5b;
		else if (i == 13) return 0x27f427ccbf58a44b1270abbe4eda6ba53bd6ac4d88cf1e00a13c4371ce71d366;
		else if (i == 14) return 0x1617eaae5064f26e8f8a6493ae92bfded7fde71b65df1ca6d5dcec0df70b2cef;
		else if (i == 15) return 0x20c6b400d0ea1b15435703c31c31ee63ad7ba5c8da66cec2796feacea575abca;
		else if (i == 16) return 0x09589ddb438723f53a8e57bdada7c5f8ed67e8fece3889a73618732965645eec;
		else if (i == 17) return 0x0064b6a738a5ff537db7b220f3394f0ecbd35bfd355c5425dc1166bf3236079b;
		else if (i == 18) return 0x095de56281b1d5055e897c3574ff790d5ee81dbc5df784ad2d67795e557c9e9f;
		...
		else if (i == 25) return 0x2328068c6a8c24265124debd8fe10d3f29f0665ea725a65e3638f6192a96a013;
		else if (i == 26) return 0x2ddb991be1f028022411b4c4d2c22043e5e751c120736f00adf54acab1c9ac14;
		else if (i == 27) return 0x0113798410eaeb95056a464f70521eb58377c0155f2fe518a5594d38cc209cc0;
		else if (i == 28) return 0x202d1ae61526f0d0d01ef80fb5d4055a7af45721024c2c24cffd6a3798f54d50;
		else if (i == 29) return 0x23ab323453748129f2765f79615022f5bebd6f4096a796300aab049a60b0f187;
		else if (i == 30) return 0x1f15585f8947e378bcf8bd918716799da909acdb944c57150b1eb4565fda8aa0;
		else if (i == 31) return 0x1eb064b21055ac6a350cf41eb30e4ce2cb19680217df3a243617c2838185ad06;
