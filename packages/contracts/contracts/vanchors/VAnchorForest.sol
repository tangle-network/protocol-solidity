...
import "../libs/VAnchorForestEncodeInputs.sol";
 ...
 */
contract VAnchorForest is VAnchorForestBase, TxProofVerifier, ISetVerifier {
	...
	*/
	...
	function registerAndTransact(
		Account memory _account,
		VAnchorForestEncodeInputs.Proof memory _proofArgs,
		ExtData memory _extData
	) public {
		register(_account);
		transact(_proofArgs, _extData);
	...
	/**
		...
		@param _extData The external data for the transaction
	 */
	function transact(VAnchorForestEncodeInputs.Proof memory _args, ExtData memory _extData) public nonReentrant {
	...
	function transactWrap(
		VAnchorForestEncodeInputs.Proof memory _args,
		ExtData memory _extData,
		address _tokenAddress
	) public payable {
		_executeValidationAndVerification(_args, _extData);
	...
	/**
		...
		@param _extData The external data for the transaction
	 */
	function _executeValidationAndVerification(VAnchorForestEncodeInputs.Proof memory _args, ExtData memory _extData) internal {
	...
	/**
		...
		@param _args The zkSNARK proof parameters
	 */
	function _executeVerification(VAnchorForestEncodeInputs.Proof memory _args) internal view {
		...
		(bytes memory encodedInput, bytes32[] memory roots) = smallInputs
			? VAnchorForestEncodeInputs._encodeInputs2(_args, maxEdges)
			: VAnchorForestEncodeInputs._encodeInputs16(_args, maxEdges);
	...
	/**
		...
		@param _extData The external data for the transaction
	 */
	function _executeInsertions(VAnchorForestEncodeInputs.Proof memory _args, ExtData memory _extData) internal {
