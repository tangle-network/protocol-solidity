...
library MASPVAnchorEncodeInputs {
	...
	function _encodeInputs2(
		...
		if (_maxEdges == 1) {
			...
			inputs[0] = uint256(_args.publicAmount);
			inputs[1] = uint256(_args.extDataHash);
			inputs[3] = uint256(_aux.publicAssetID);
			inputs[4] = uint256(_aux.publicTokenID);
			...
			inputs[9] = uint256(_chainId);
			inputs[10] = uint256(roots[0]);
			inputs[11] = uint256(roots[1]);
			inputs[12] = uint256(roots[2]);
			inputs[13] = uint256(roots[3]);
			inputs[14] = uint256(roots[4]);
			inputs[15] = uint256(roots[5]);
			inputs[16] = uint256(roots[6]);
			inputs[17] = uint256(roots[7]);
			inputs[18] = uint256(_aux.ak_alpha_X[0]);
			inputs[19] = uint256(_aux.ak_alpha_X[1]);
			inputs[20] = uint256(_aux.ak_alpha_Y[0]);
			inputs[21] = uint256(_aux.ak_alpha_Y[1]);
			inputs[22] = uint256(_aux.whitelistedAssetIDs[0]);
			inputs[23] = uint256(_aux.whitelistedAssetIDs[1]);
			inputs[24] = uint256(_aux.whitelistedAssetIDs[2]);
			inputs[25] = uint256(_aux.whitelistedAssetIDs[3]);
			inputs[26] = uint256(_aux.whitelistedAssetIDs[4]);
			inputs[27] = uint256(_aux.whitelistedAssetIDs[5]);
			inputs[28] = uint256(_aux.whitelistedAssetIDs[6]);
			inputs[29] = uint256(_aux.whitelistedAssetIDs[7]);
			inputs[30] = uint256(_aux.whitelistedAssetIDs[8]);
			inputs[31] = uint256(_aux.whitelistedAssetIDs[9]);
			inputs[32] = uint256(_aux.feeInputNullifiers[0]);
			inputs[33] = uint256(_aux.feeInputNullifiers[1]);
			inputs[34] = uint256(_aux.feeOutputCommitments[0]);
			inputs[35] = uint256(_aux.feeOutputCommitments[1]);
			inputs[36] = uint256(_aux.fee_ak_alpha_X[0]);
			inputs[37] = uint256(_aux.fee_ak_alpha_X[1]);
			inputs[38] = uint256(_aux.fee_ak_alpha_Y[0]);
			inputs[39] = uint256(_aux.fee_ak_alpha_Y[1]);
			encodedInput = abi.encodePacked(inputs);
		} else {
