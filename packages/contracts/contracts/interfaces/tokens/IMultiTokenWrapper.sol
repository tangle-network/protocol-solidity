...
interface IMultiTokenWrapper {
     ...
     */
    function wrap(address _fromTokenAddress, address _toTokenAddress, uint256 _amount) payable external;
     ...
     */
    function unwrapAndSendTo(address _fromTokenAddress, address _toTokenAddress, uint256 _amount, address _recipient) external;
    ...
    /**
        ...
        @param _amount Amount of tokens to wrap
     */
    function wrapFor(address _sender, address _fromTokenAddress, address _toTokenAddress, uint256 _amount) payable external;
     ...
     */
    function wrapForAndSendTo(address _sender, address _fromTokenAddress, address _toTokenAddress,  uint256 _amount, address _mintRecipient) payable external;
    ...
    /**
        ...
        @param _amount Amount of tokens to unwrap
     */
    function unwrapFor(address _sender, address _fromTokenAddress, address _toTokenAddress, uint256 _amount) external;
     ...
     */
    function getFeeFromAmount(address _toTokenAddress, uint _amountToWrap) external view returns (uint);
