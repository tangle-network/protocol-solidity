...
Adds a token at `_tokenAddress` to the FungibleTokenWrapper&#39;s wrapping listOnly the handler can call this function
...
Removes a token at `_tokenAddress` from the FungibleTokenWrapper&#39;s wrapping listOnly the handler can call this function
...
Sets a new `_feePercentage` for the FungibleTokenWrapperOnly the handler can call this function
...
Sets a new `_feeRecipient` for the FungibleTokenWrapperOnly the handler can call this function
...
Sets the handler of the FungibleTokenWrapper contractOnly the handler can call this function
