...
> Handles Treasury rescue tokens proposal
...
| Name | Type | Description |
|---|---|---|
| resourceID | bytes32 | ResourceID corresponding to a particular set of Treasury contracts
| data | bytes | passed into the function should be constructed as follows: resourceID: bytes 0-32 functionSig: bytes 32-36 arguments: bytes 36- First 4 bytes of argument is nonce.  
