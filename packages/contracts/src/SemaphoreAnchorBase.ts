...
export interface SemaphoreAnchorBaseInterface extends utils.Interface {
  functions: {
...
export interface SemaphoreAnchorBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SemaphoreAnchorBaseInterface;
