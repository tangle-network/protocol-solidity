...
interface SignatureBridgeInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'isCorrectExecutionChain', values: [BytesLike]): string;
  encodeFunctionData(functionFragment: 'isCorrectExecutionContext', values: [BytesLike]): string;
  ...
  decodeFunctionResult(functionFragment: 'isCorrectExecutionChain', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'isCorrectExecutionContext', data: BytesLike): Result;
...
export class SignatureBridge extends BaseContract {
  ...
  functions: {
    ...
    isCorrectExecutionChain(resourceID: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;

    isCorrectExecutionContext(resourceId: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    isCorrectExecutionChain(resourceID: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;

    isCorrectExecutionContext(resourceId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    isCorrectExecutionChain(resourceID: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    isCorrectExecutionContext(resourceId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
