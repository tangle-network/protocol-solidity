...
interface BridgeHandlerInterface extends ethers.utils.Interface {
  functions: {
...
export class BridgeHandler extends BaseContract {
  ...
  interface: BridgeHandlerInterface;
  ...
  functions: {
    ...
    _updateRecords(
      ...
      [string, BigNumber, BigNumber, string, string, string] & {
        _signatureBridgeAddress: string;
