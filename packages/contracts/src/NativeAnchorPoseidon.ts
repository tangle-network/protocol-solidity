...
export interface NativeAnchorPoseidonInterface extends utils.Interface {
  functions: {
...
export interface NativeAnchorPoseidon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NativeAnchorPoseidonInterface;
