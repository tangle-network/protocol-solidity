...
export interface MerkleTreePoseidonMockInterface extends utils.Interface {
  functions: {
...
export interface MerkleTreePoseidonMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MerkleTreePoseidonMockInterface;
