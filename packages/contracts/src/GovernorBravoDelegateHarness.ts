...
export interface GovernorBravoDelegateHarnessInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "_initiate", values?: undefined): string;
  encodeFunctionData(
...
export interface GovernorBravoDelegateHarness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorBravoDelegateHarnessInterface;
  ...
  callStatic: {
    ...
    "_initiate()"(overrides?: CallOverrides): Promise<void>;
