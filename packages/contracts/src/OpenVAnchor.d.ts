...
interface OpenVAnchorInterface extends ethers.utils.Interface {
  functions: {
    ...
    'deposit(uint48,uint256,address,bytes,uint256,uint256)': FunctionFragment;
    ...
    'withdraw(uint256,address,bytes,uint256,uint256,bytes32[],uint32,bytes32)': FunctionFragment;
    'withdrawAndUnwrap(uint256,address,bytes,uint256,uint256,bytes32[],uint32,bytes32,address)': FunctionFragment;
    'wrapAndDeposit(uint48,uint256,address,bytes,uint256,uint256,address)': FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, BigNumberish, string, BytesLike, BigNumberish, BigNumberish]
  ): string;
  ...
  encodeFunctionData(functionFragment: 'register', values: [{ owner: string; keyData: BytesLike }]): string;
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, string, BytesLike, BigNumberish, BigNumberish, BytesLike[], BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: 'withdrawAndUnwrap',
    values: [BigNumberish, string, BytesLike, BigNumberish, BigNumberish, BytesLike[], BigNumberish, BytesLike, string]
  ): string;
  encodeFunctionData(
    functionFragment: 'wrapAndDeposit',
    values: [BigNumberish, BigNumberish, string, BytesLike, BigNumberish, BigNumberish, string]
  ): string;
  ...
  decodeFunctionResult(functionFragment: 'wrapAndDeposit', data: BytesLike): Result;
...
export class OpenVAnchor extends BaseContract {
  ...
  interface: OpenVAnchorInterface;
  ...
  callStatic: {
    ...
    _executeWrapping(_tokenAddress: string, depositAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    register(_account: { owner: string; keyData: BytesLike }, overrides?: CallOverrides): Promise<void>;
