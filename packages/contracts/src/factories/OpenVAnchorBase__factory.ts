...
import type { OpenVAnchorBase, OpenVAnchorBaseInterface } from '../OpenVAnchorBase';
...
export class OpenVAnchorBase__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): OpenVAnchorBase {
