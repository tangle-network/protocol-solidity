...
import type { VAnchorBaseV2, VAnchorBaseV2Interface } from "../VAnchorBaseV2";
...
export class VAnchorBaseV2__factory {
  static readonly abi = _abi;
  static createInterface(): VAnchorBaseV2Interface {
    return new utils.Interface(_abi) as VAnchorBaseV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VAnchorBaseV2 {
    return new Contract(address, _abi, signerOrProvider) as VAnchorBaseV2;
  }
}
