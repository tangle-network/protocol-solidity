...
interface Verifier3Interface extends ethers.utils.Interface {
  functions: {
...
export class Verifier3 extends BaseContract {
  ...
  functions: {
    verifyProof(
      ...
      input: [BigNumberish, BigNumberish, BigNumberish, BigNumberish, BigNumberish, BigNumberish],
