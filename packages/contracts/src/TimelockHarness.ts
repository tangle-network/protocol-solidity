...
export interface TimelockHarnessInterface extends utils.Interface {
  functions: {
...
export interface TimelockHarness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TimelockHarnessInterface;
