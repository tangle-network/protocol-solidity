...
export interface GTokenWrapperMockInterface extends utils.Interface {
  functions: {
...
export interface GTokenWrapperMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GTokenWrapperMockInterface;
  ...
  callStatic: {
    ...
    add(tokenAddress: string, overrides?: CallOverrides): Promise<void>;
