...
export type PermissionedAccountsStruct = {
  bridge: string;
  admin: string;
  handler: string;
};

export type PermissionedAccountsStructOutput = [string, string, string] & {
  bridge: string;
  admin: string;
  handler: string;
};
...
export type EdgeStructOutput = [BigNumber, string, BigNumber] & {
  chainID: BigNumber;
  root: string;
  latestLeafIndex: BigNumber;
};

export type AccountStruct = { owner: string; publicKey: BytesLike };
...
export interface VAnchorBaseInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [AccountStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "registerAndTransact",
    values: [AccountStruct, ProofStruct, ExtDataStruct]
  ): string;
  encodeFunctionData(functionFragment: "roots", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "token", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "transact",
    values: [ProofStruct, ExtDataStruct]
  ): string;
  encodeFunctionData(
...
export type PublicKeyEventFilter = TypedEventFilter<PublicKeyEvent>;

export interface VAnchorBase extends BaseContract {
  ...
  functions: {
    ...
    getLatestNeighborEdges(
      overrides?: CallOverrides
    ): Promise<[EdgeStructOutput[]] & { edges: EdgeStructOutput[] }>;
    ...
    register(
      _account: AccountStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    registerAndTransact(
      _account: AccountStruct,
      _proofArgs: ProofStruct,
      _extData: ExtDataStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    register(_account: AccountStruct, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "NewNullifier(bytes32)"(nullifier?: null): NewNullifierEventFilter;
    NewNullifier(nullifier?: null): NewNullifierEventFilter;

    "PublicKey(address,bytes)"(
      owner?: string | null,
      key?: null
    ): PublicKeyEventFilter;
    PublicKey(owner?: string | null, key?: null): PublicKeyEventFilter;
  };
