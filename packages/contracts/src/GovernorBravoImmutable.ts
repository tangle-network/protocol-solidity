...
export interface GovernorBravoImmutableInterface extends utils.Interface {
  functions: {
...
export interface GovernorBravoImmutable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorBravoImmutableInterface;
