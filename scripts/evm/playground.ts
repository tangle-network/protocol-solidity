...
import { toFixedHex, Note, Keypair, CircomUtxo, Utxo, calculateTypedChainId, ChainType } from '@webb-tools/sdk-core';
...
async function run() {
  const vanchor = VAnchor__factory.connect('0x4e3df2073bf4b43b9944b8e5a463b1e185d6448c', walletGanache);
