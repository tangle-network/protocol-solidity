...
export async function run() {
  ...
  const providerHarmonyTestnet1 = new ethers.providers.JsonRpcProvider(`https://api.s1.b.hmny.io`);
  const walletHarmonyTestnet1 = new ethers.Wallet(process.env.PRIVATE_KEY!, providerHarmonyTestnet1);

  const bridgeInput: BridgeInput = {
    anchorInputs: {
      asset: {
        4: ['0x7Cec2Bf7D9c4C3C96Da8a0BfeBAB1E84b8212394'],
        1666700001: ['0x9d609F54536Cef34f5F612BD976ca632F1fa208E'],
      },
      anchorSizes: ['100000000000000000'],
    },
    chainIDs: [4, 1666700001],
  };
  ...
  const deployers: DeployerConfig = {
    // 3: walletRopsten,
    4: walletRinkeby,
    1666700000: walletHarmonyTestnet1,
  };
