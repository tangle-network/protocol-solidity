import fs from 'fs';
import { Contract, ConvertToKebabCase, EventsWatcher, FullChainInfo, LinkedAnchor, ProposalSigningBackend, WithdrawConfig } from "@webb-tools/test-utils";
...
export function writeEvmChainConfig (
  path: string,
