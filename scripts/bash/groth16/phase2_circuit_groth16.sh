...
move_verifiers_and_metadata_vanchor () {
    ...
    sed -i 's/pragma solidity ^0.6.11;/pragma solidity ^0.8.19;/g' packages/contracts/contracts/verifiers/$anchorType/Verifier"$size"_"$nIns".sol
}
...
move_verifiers_and_metadata_identity_vanchor () {
    ...
    sed -i 's/pragma solidity ^0.6.11;/pragma solidity ^0.8.19;/g' packages/contracts/contracts/verifiers/$anchorType/VerifierID"$size"_"$nIns".sol
}
...
move_verifiers_and_metadata_vanchor_forest () {
    ...
    sed -i 's/pragma solidity ^0.6.11;/pragma solidity ^0.8.19;/g' packages/contracts/contracts/verifiers/$anchorType/VerifierF"$size"_"$nIns".sol
}
