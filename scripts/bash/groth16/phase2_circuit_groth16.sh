compile_phase2 () {
    ...
    npx snarkjs groth16 setup "$pathToCircuitDir/$circuit.r1cs" ./solidity-fixtures/ptau/powersOfTau28_hez_final_22.ptau "$outdir/circuit_0000.zkey"
    echo "test" | npx snarkjs zkey contribute "$outdir/circuit_0000.zkey" "$outdir/circuit_0001.zkey" --name"1st Contributor name" -v
    npx snarkjs zkey verify "$pathToCircuitDir/$circuit.r1cs" ./solidity-fixtures/ptau/powersOfTau28_hez_final_22.ptau "$outdir/circuit_0001.zkey"
    ...
    npx snarkjs zkey verify "$pathToCircuitDir/$circuit.r1cs" ./solidity-fixtures/ptau/powersOfTau28_hez_final_22.ptau "$outdir/circuit_final.zkey"
