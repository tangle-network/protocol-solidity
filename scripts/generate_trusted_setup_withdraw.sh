...
echo 'snarkjs powersoftau new bn128 16 $OUTPUT_DIR/pot12_0000.ptau -v\n'
snarkjs powersoftau new bn128 16 $OUTPUT_DIR/pot12_0000.ptau -v
wait 500

echo 'echo "test" | snarkjs powersoftau contribute $OUTPUT_DIR/pot12_0000.ptau $OUTPUT_DIR/pot12_0001.ptau --name="First contribution" -v\n'
echo "test" | snarkjs powersoftau contribute $OUTPUT_DIR/pot12_0000.ptau $OUTPUT_DIR/pot12_0001.ptau --name="First contribution" -v
wait 500

# Verify phase 1
echo 'snarkjs powersoftau verify $OUTPUT_DIR/pot12_0001.ptau\n'
snarkjs powersoftau verify $OUTPUT_DIR/pot12_0001.ptau
wait 500

# Apply random beacon
echo 'snarkjs powersoftau beacon $OUTPUT_DIR/pot12_0001.ptau $OUTPUT_DIR/pot12_beacon.ptau 0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f 10 -n="Final Beacon"\n'
...
# Prapare phase 2
echo 'snarkjs powersoftau prepare phase2 $OUTPUT_DIR/pot12_0001.ptau pot12_final.ptau -v\n'
snarkjs powersoftau prepare phase2 $OUTPUT_DIR/pot12_0001.ptau pot12_final.ptau -v
wait 500

# Start a new zkey and make a contribution (enter some random text)
echo 'snarkjs groth16 setup $1 $OUTPUT_DIR/pot12_final.ptau $OUTPUT_DIR/circuit_0000.zkey\n'
snarkjs groth16 setup $1 $OUTPUT_DIR/pot12_final.ptau $OUTPUT_DIR/circuit_0000.zkey
wait 500
...
# Verify zkey
echo 'snarkjs zkey verify $1 $OUTPUT_DIR/pot12_final.ptau $OUTPUT_DIR/circuit_0001.zkey\n'
snarkjs zkey verify $1 $OUTPUT_DIR/pot12_final.ptau $OUTPUT_DIR/circuit_0001.zkey
wait 500
...
# Verify final zkey
echo 'snarkjs zkey verify $1 $OUTPUT_DIR/pot12_final.ptau $OUTPUT_DIR/circuit_final.zkey\n'
snarkjs zkey verify $1 $OUTPUT_DIR/pot12_final.ptau $OUTPUT_DIR/circuit_final.zkey
wait 500
