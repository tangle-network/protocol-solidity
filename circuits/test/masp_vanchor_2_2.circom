...
component main {public [publicAmount, extDataHash, publicAssetID, publicTokenID, inputNullifier, outputCommitment, chainID, roots, ak_alpha_X, ak_alpha_Y, whitelistedAssetIDs, feeInputNullifier, feeOutputCommitment, fee_ak_alpha_X, fee_ak_alpha_Y]} = Transaction(30, 2, 2, 2, 2,11850551329423159860688778991827824730037759162201783566284850822760196767874, 2, 10);