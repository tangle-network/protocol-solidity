...
exports.Keypair = exports.unpackEncryptedMessage = exports.packEncryptedMessage = void 0;
...
class Keypair {
    ...
    constructor(privkey = ethers_1.ethers.Wallet.createRandom().privateKey) {
        ...
        this.pubkey = (0, utils_1.poseidonHash)([this.privkey]);
        this.encryptionKey = (0, eth_sig_util_1.getEncryptionPublicKey)(privkey.slice(2));
    }
    toString() {
        return (0, utils_1.toFixedHex)(this.pubkey) + Buffer.from(this.encryptionKey, 'base64').toString('hex');
    }
    /**
     ...
     */
    decrypt(data) {
        return Buffer.from((0, eth_sig_util_1.decrypt)(unpackEncryptedMessage(data), this.privkey.slice(2)), 'base64');
    }
}
