...
contract('E2E LinkableAnchors - Cross chain withdraw using historical root should work', async accounts => {
  ...
  it('withdrawing across bridge after two deposits should work', async () => {
    ...
    */
    ...
    res = await snarkjs.groth16.prove('test/fixtures/bridge/2/circuit_final.zkey', wtns);
    proof = res.proof;
    publicSignals = res.publicSignals;
    vKey = await snarkjs.zKey.exportVerificationKey('test/fixtures/bridge/2/circuit_final.zkey');
