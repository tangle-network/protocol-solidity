...
contract('GovernedTokenWrapper', (accounts) => {
  ...
  it('should fail to wrap with no limit', async () => {
    ...
    await TruffleAssert.reverts(
      wrapper.wrapFor(root, token.address, '1000000000000000000000000'),
  ...
  it('should wrap only after token has been whitelisted', async () => {
    ...
    await helpers.addTokenToWrapper(gov, wrapper, token, root, states);
    await TruffleAssert.passes(wrapper.wrapFor(root, token.address, '1000000000000000000000000'));
    await TruffleAssert.reverts(
      wrapper.wrapFor(root, token.address, '1000000000000000000000000'),
      'Invalid token amount',
    );
  ...
  it('should be able to wrap directly', async () => {
    ...
    await helpers.addTokenToWrapper(gov, wrapper, token, root, states);
    await TruffleAssert.passes(wrapper.wrap(token.address, '1000000000000000000000000', {from: acct}));
  });
  ...
  it('should wrap after increasing limit', async () => {
    ...
    await TruffleAssert.reverts(
      wrapper.wrapFor(root, token.address, amount),
      'Invalid token address',
    );
    ...
    await TruffleAssert.passes(wrapper.wrapFor(root, token.address, amount));
    await TruffleAssert.reverts(
      wrapper.wrapFor(root, token.address, '1000000000000000000000000'),
      'Invalid token amount',
    );
