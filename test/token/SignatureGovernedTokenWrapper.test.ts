 ...
 */
 ...
 import { ERC20 as ERC20Class, SignatureGovernedTokenWrapper as SignatureGovernedTokenWrapperClass } from '../../packages/tokens/src';
 
 describe('GovernedTokenWrapper', () => {
   let token: ERC20Class;
   let wrappedToken: SignatureGovernedTokenWrapperClass;
   ...
   beforeEach(async () => {
     ...
     wrappedToken = await SignatureGovernedTokenWrapperClass.createSignatureGovernedTokenWrapper(
       wrappedTokenName,
       wrappedTokenSymbol,
       sender.address,
       tokenDenomination,
