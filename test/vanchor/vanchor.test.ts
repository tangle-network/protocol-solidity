...
describe('VAnchor for 2 max edges', () => {
  ...
  describe('#transact', () => {
    ...
    it.only('should be able to transfer without direct communication between sender and recipient', async function () {
      ...
      console.log('aliceTransferUtxo: ', aliceTransferUtxo.serialize());
